...
`)
	...
	viper.Set("default_client_id", "authcore-io")
	config.InitConfig()
	...
	service := NewService(db, redisClient, userStore, sessionStore, authenticationService, auditStore, emailService, smsService)
